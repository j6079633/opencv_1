...
BEGIN_MESSAGE_MAP(CCVAssignment1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CCVAssignment1App 建構

CCVAssignment1App::CCVAssignment1App()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CCVAssignment1App 物件

CCVAssignment1App theApp;


// CCVAssignment1App 初始設定

BOOL CCVAssignment1App::InitInstance()
{
